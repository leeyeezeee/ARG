...
from experiment.svamp.gsm8k_prompt_set import ROLE_DESCRIPTION
...
SPEC = RLDatasetSpec(
    ...
    default_output_dir="./output/svamp_rl_edge_model",
    default_dataset_path="../../datasets/SVAMP/SVAMP.json",
    default_task_split_path="./task_split_svamp.json",
